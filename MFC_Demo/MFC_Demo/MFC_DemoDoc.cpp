...
// MFC_DemoDoc.cpp : CMFC_DemoDoc 类的实现
//
...
// 缩略图的支持
void CMFC_DemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMFC_DemoDoc::InitializeSearchContent()
{
...
void CMFC_DemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
